const PRE_EVENT = {
  high: [
    { first: "⏳ Через {min} минут выходят важные данные.", second: "Рынок начинает реагировать." },
    ...
    { first: "⏳ Через {min} минут ожидаются важные цифры.", second: "Рынок входит в фазу ожидания." },
    { first: "⏳ Через {min} минут выходят данные.", second: "Активность может вырасти." },
  ],
  anchor: [
    { first: "⚡ Через {min} минут — {event}.", second: "Рынок начинает реагировать." },
    { first: "⚡ {event} — через {min} минут.", second: "Движения могут стать заметнее." },
    { first: "⚡ Через {min} минут ожидается {event}.", second: "Рынок входит в фазу ожидания." },
    { first: "⚡ {event} через {min} минут.", second: "Возможно оживление на рынке." },
  ...
  stack: [
    ...
    { first: "⏳ С {time} публикации пойдут одна за другой.", second: "Рынок может оставаться подвижным в этот период." },
    { first: "⏳ Через {min} минут серия экономических публикаций.", second: "Движение может быть неравномерным." },
    { first: "⏳ В ближайшие минуты несколько релизов подряд.", second: "Рынок входит в активный период." },
    { first: "⏳ С {time} блок данных без пауз.", second: "Цена может реагировать на каждый." },
  ],
  anchorStack: [
    { first: "⚡ С {time} серия публикаций, включая {event}.", second: "Рынок входит в активный период." },
    { first: "⚡ Через {min} минут блок данных, среди них {event}.", second: "Движения могут идти волнами." },
    { first: "⚡ В ближайшие минуты несколько релизов подряд, включая {event}.", second: "Рынок начинает реагировать." },
    { first: "⚡ С {time} данные идут один за другим, включая {event}.", second: "Активность может нарастать постепенно." },
...
const GREEN = {
  single: [
    { first: "🟢 Окно публикации закрыто.", second: "Рынок вернулся к обычному ритму." },
    { first: "🟢 Фаза события завершена.", second: "Движения пришли в норму." },
    { first: "🟢 Активный период закончился.", second: "Рынок в стандартной фазе." },
    { first: "🟢 Окно волатильности закрыто.", second: "Рынок успокоился." },
    { first: "🟢 Публикация отработана.", second: "Движения нормализованы." },
    { first: "🟢 Активная фаза завершена.", second: "Рынок в обычном ритме." },
  ],
  cluster: [
    { first: "🟢 Окно серии публикаций закрыто.", second: "Рынок вернулся к обычному ритму." },
    { first: "🟢 Блок данных отработан.", second: "Движения пришли в норму." },
    { first: "🟢 Период публикаций завершён.", second: "Рынок успокоился." },
    { first: "🟢 Серия релизов закрыта.", second: "Рынок в стандартной фазе." },
    { first: "🟢 Активное окно закрыто.", second: "Движения нормализованы." },
  ],
};
