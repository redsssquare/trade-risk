#!/usr/bin/env node
/**
 * Импортирует или обновляет workflow "Weekly Ahead" в n8n из файла
 * n8n-weekly-ahead-workflow.json и активирует его.
 * Требует N8N_API_KEY в .env (n8n: Settings → API).
 *
 * Локально:  node scripts/push-weekly-ahead-workflow.js
 * Docker:   docker compose run --rm --entrypoint node -e N8N_BASE_URL=http://n8n:5678 -v "$(pwd):/app" -w /app bridge scripts/push-weekly-ahead-workflow.js
 */
...
const WORKFLOW_NAME = "Weekly Ahead";
const WORKFLOW_FILE = "n8n-weekly-ahead-workflow.json";
