...
|---|---|---|---|---|---|---|
| 2026-03-03T11:40:00Z | US Retail Sales, 2026-03-03T12:00:00Z, High | US Retail Sales @ 12:00 | pre_event | high | false | [] |
| 2026-03-03T12:02:00Z | US Retail Sales, 2026-03-03T12:00:00Z, High | US Retail Sales @ 12:00 | during_event | high | false | [] |
| 2026-03-03T12:08:00Z | US Retail Sales, 2026-03-03T12:00:00Z, High | US Retail Sales @ 12:00 | post_event | high | false | [] |
| 2026-03-03T12:16:00Z | US Retail Sales, 2026-03-03T12:00:00Z, High | null | none (GREEN) | null | false | [] |

## Сценарий 2: Один anchor_high (pre -> during -> post)

| now | events (name, time, impact) | expected primary_event | expected phase | expected impact_type | contextual_anchor | contextual_anchor_names |
|---|---|---|---|---|---|---|
| 2026-03-03T13:45:00Z | FOMC Rate Decision, 2026-03-03T14:00:00Z, High | FOMC Rate Decision @ 14:00 | pre_event | anchor_high | false | [] |
| 2026-03-03T14:03:00Z | FOMC Rate Decision, 2026-03-03T14:00:00Z, High | FOMC Rate Decision @ 14:00 | during_event | anchor_high | false | [] |
| 2026-03-03T14:10:00Z | FOMC Rate Decision, 2026-03-03T14:00:00Z, High | FOMC Rate Decision @ 14:00 | post_event | anchor_high | false | [] |

## Сценарий 3: High + anchor внутри одного окна

| now | events (name, time, impact) | expected primary_event | expected phase | expected impact_type | contextual_anchor | contextual_anchor_names |
|---|---|---|---|---|---|---|
| 2026-03-03T10:05:00Z | UK GDP q/q, 2026-03-03T10:10:00Z, High; CPI y/y, 2026-03-03T10:18:00Z, High | UK GDP q/q @ 10:10 | pre_event | high | true | ["CPI y/y"] |
| 2026-03-03T10:17:00Z | UK GDP q/q, 2026-03-03T10:10:00Z, High; CPI y/y, 2026-03-03T10:18:00Z, High | CPI y/y @ 10:18 | pre_event | anchor_high | false | [] |
...
| 2026-03-03T09:42:00Z | German Ifo, 2026-03-03T09:30:00Z, High; Eurozone PMI, 2026-03-03T09:50:00Z, High | Eurozone PMI @ 09:50 | pre_event | high | false | [] |
...
| 2026-03-03T15:12:00Z | US ISM Services, 2026-03-03T15:00:00Z, High; FOMC Minutes, 2026-03-03T15:20:00Z, High | FOMC Minutes @ 15:20 | pre_event | anchor_high | false | [] |

## Сценарий 6: Событие уже прошло (post -> green)

| now | events (name, time, impact) | expected primary_event | expected phase | expected impact_type | contextual_anchor | contextual_anchor_names |
|---|---|---|---|---|---|---|
| 2026-03-03T08:07:00Z | CAD Employment Change, 2026-03-03T08:00:00Z, High | CAD Employment Change @ 08:00 | post_event | high | false | [] |
| 2026-03-03T08:16:00Z | CAD Employment Change, 2026-03-03T08:00:00Z, High | null | none (GREEN) | null | false | [] |
...
1. **Как задать now вручную:** поочередно подставьте `2026-03-03T11:40:00Z`, `2026-03-03T12:02:00Z`, `2026-03-03T12:08:00Z`, `2026-03-03T12:16:00Z`.
...
1. **Как задать now вручную:** `2026-03-03T13:45:00Z`, `2026-03-03T14:03:00Z`, `2026-03-03T14:10:00Z`.
...
1. **Как задать now вручную:** `2026-03-03T10:05:00Z`, затем `2026-03-03T10:17:00Z`.
2. **Как подставить events JSON:** `[{"title":"UK GDP q/q","date":"2026-03-03T10:10:00Z","impact":"High","currency":"GBP"},{"title":"CPI y/y","date":"2026-03-03T10:18:00Z","impact":"High","currency":"USD"}]`.
...
5. **Успех:** в `10:05` primary=`UK GDP`, `impact_type=high`, `contextual_anchor=true`, `contextual_anchor_names=["CPI y/y"]`; в `10:17` primary=`CPI y/y`, `impact_type=anchor_high`, `contextual_anchor=false`.
6. **Ошибка:** anchor не учитывается в окне, либо не происходит переключение primary на более близкое.

### Сценарий 4: Два High подряд без anchor

1. **Как задать now вручную:** `2026-03-03T09:25:00Z`, затем `2026-03-03T09:42:00Z`.
...
1. **Как задать now вручную:** `2026-03-03T14:58:00Z`, затем `2026-03-03T15:12:00Z`.
...
5. **Успех:** в `14:58` primary=`US ISM Services`, `impact_type=high`, `contextual_anchor=false`; в `15:12` primary=`FOMC Minutes`, `impact_type=anchor_high`, `contextual_anchor=false`.
6. **Ошибка:** anchor не становится primary при приближении, или появляется неверный contextual anchor.

### Сценарий 6: Событие уже прошло (post -> green)

1. **Как задать now вручную:** `2026-03-03T08:07:00Z`, затем `2026-03-03T08:16:00Z`.
2. **Как подставить events JSON:** `[{"title":"CAD Employment Change","date":"2026-03-03T08:00:00Z","impact":"High","currency":"CAD"}]`.
3. **Какие поля должны попасть в bridge:** в `08:07` ожидается полный контекст, в `08:16` — `state=GREEN`, `phase=none`, `context=null`.
...
6. **Ошибка:** остаётся `RED` после `event_time+15m`, или отправляется контекст для GREEN.
